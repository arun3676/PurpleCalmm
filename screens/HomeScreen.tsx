...
import PurrpleHero from '../components/PurrpleHero';
import CategoryGrid from '../components/CategoryGrid';
import PawBanner from '../components/PawBanner';
...
export default function HomeScreen({ navigation }: Props) {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: ClassicLilac.pageBg }} contentContainerStyle={{ paddingBottom: 24 }}>
      <PurrpleHero />
      <CategoryGrid />
      <PawBanner />
