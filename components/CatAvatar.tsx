...
export default function CatAvatar({ moodLevel = 0, size = 140 }: { moodLevel?: number; size?: number }) {
  ...
  return (
    <View style={{ alignItems: 'center' }}>
      <View style={{ width: size, height: size, borderRadius: r, backgroundColor: colors.primaryDarker, alignItems: 'center', justifyContent: 'center' }}>
        <Svg width={Math.min(0.9*size, 64)} height={Math.min(0.9*size, 64)} viewBox="0 0 64 64">
